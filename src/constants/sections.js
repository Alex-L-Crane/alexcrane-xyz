export const pageSections = [
  { path: '/', label: 'Home', dark: false},
  { path: '/equipment', label: 'Equipment', dark: false},
  { path: '/projects/feed', label: 'Feed', dark: false, skipNav: true},
  { path: '/projects/music', label: 'Music', dark: false, skipNav: true },
  { path: '/projects/design', label: 'Tech/Design', dark: true, skipNav: true},
  { path: '/projects', label: 'Projects', dark: true, skipNav: true},
  { path: '/about/philosophy', label: 'Philosophy', skipNav: true},
