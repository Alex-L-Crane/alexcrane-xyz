<template>
  ...
  <div class="body-column flex flex-col lg:flex-row items-start lg:items-end lg:justify-between">
    <div class="mb-8 lg:mb-0 mt-16 flex flex-col lg:w-[200px]">
      ...
      <p class="hidden lg:block text-xs font-thin text-white/60 mt-4">© {{ currentYear }} Alex Crane</p>
    </div>
    <div class="mb-8 lg:mb-0 mt-16 lg:pr-40 self-start lg:self-end">
      <ul>
        ...
        <li><a href="/about" class="text-white font-thin inline-block mb-4 hover:opacity-80 focus-visible:opacity-80">Overview</a></li>
        <li><a href="/music" class="text-white font-thin inline-block mb-4 hover:opacity-80 focus-visible:opacity-80">Music</a></li>
        <li><a href="/design" class="text-white font-thin inline-block mb-4 hover:opacity-80 focus-visible:opacity-80">Design</a></li>
        <li><a href="/philosophy" class="text-white font-thin inline-block mb-4 hover:opacity-80 focus-visible:opacity-80">Philosophy</a></li>
        <li><a href="/AlexCrane-Resume.pdf" class="text-white font-thin inline-block hover:opacity-80 focus-visible:opacity-80" target="_blank" rel="noopener noreferrer">Resume</a></li>
      </ul>
      <button
        ref="colophonTrigger"
        type="button"
    ...
    <div class="w-full lg:w-auto mt-16 self-start lg:self-end">
      ...
      <form
        ...
        <label
          for="email"
          class="inline-block text-sm/6 font-light text-white"></label>
        <input
          type="email"
          name="email"
          class="h-10
      ...
      <div class="flex flex-wrap items-center gap-2 mt-6">
        <a href="https://www.youtube.com/@alexlcrane" target="_blank" rel="noopener noreferrer" class="text-white font-thin hover:opacity-80 focus-visible:opacity-80">YouTube</a>
        <span aria-hidden="true" class="text-white/40">·</span>
        <a href="https://www.instagram.com/alexlcrane/" target="_blank" rel="noopener noreferrer" class="text-white font-thin hover:opacity-80 focus-visible:opacity-80">Instagram</a>
        <span aria-hidden="true" class="text-white/40">·</span>
        <a href="https://substack.com/@alexlcrane" target="_blank" rel="noopener noreferrer" class="text-white font-thin hover:opacity-80 focus-visible:opacity-80">Substack</a>
        <span aria-hidden="true" class="text-white/40">·</span>
        <a href="https://www.linkedin.com/in/alex-l-crane/" target="_blank" rel="noopener noreferrer" class="text-white font-thin hover:opacity-80 focus-visible:opacity-80">LinkedIn</a>
      </div>
    </div>
  </div>
  <div class="body-column mt-8 lg:hidden">
    <p class="text-xs font-thin text-white/60">© {{ currentYear }} Alex Crane</p>
  </div>
  </div>
</template>
<script setup>
