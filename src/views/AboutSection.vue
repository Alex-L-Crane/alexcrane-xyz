    ...
    <div class="flex px-2 sm:px-4 md:px-8">
      ...
      <div class="w-full body-column lg:w-3/4">
        ...
        <div class="prose-col mb-8">
          <p class="body-copy">
            That's where my mind lives: where the drum as acoustic instrument intersects with the surrounding spaces and the microphone as witness. Where music, <em>and culture</em>, begin.
          </p>
          <p class="body-copy">
