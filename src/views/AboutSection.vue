...
<template>
  <main class="atacamamedium bg-[#F6D9CE] text-[#444244] pt-14 lg:pt-20 text-black">
    ...
    <div class="section-panel mobile-gutter">
      <img :src="backgroundAbstract3" alt="" width="1024" height="248" class="aspect-[3/2] lg:aspect-auto w-full object-cover object-[75%_center]"/>
    ...
    <div class="mobile-gutter mt-6 lg:mb-16 lg:pl-48">
    ...
    <div class="flex px-2 sm:px-4 md:px-8">
      ...
      <div class="w-full md:max-w-[36rem] md:mx-auto lg:max-w-none lg:w-3/4 lg:mx-0">
