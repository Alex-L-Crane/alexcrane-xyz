    ...
    <div class="flex px-2 sm:px-4 md:px-8">
      ...
      <div class="w-full body-column lg:w-3/4">
        ...
        <div class="prose-col mb-8">
          <p class="body-copy">
            That's where my mind lives: where the drum as acoustic instrument intersects with the surrounding spaces and the microphone as witness. That's where music, <em>and culture</em>, exists.
          </p>
          <p class="body-copy">
        ...
        <div class="lg:pl-[40rem] mb-8 lg:mb-16">
          <div class="flex align-baseline lg:max-w-[18rem] pt-6 lg:pt-8 pb-4 relative z-0">
            <p><span class="alaska tracking-tight mr-2"><em>kaizen (Japanese):</em></span>
              <em class="alaska font-thin">The practice of continually seeking improvement.</em>
            </p>
          </div>
        </div>
        <div class="prose-col lg:mb-8">
          <p class="body-copy">
            I didn’t know the word “ideology” when I first sensed it, but I knew it was everywhere.
            Trying to understand the world involves plodding through a web of conflicting beliefs.
