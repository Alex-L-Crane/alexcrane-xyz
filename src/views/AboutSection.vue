      ...
      <div class="w-full lg:w-3/4">
        ...
        <div class="md:max-w-[36rem] md:mb-8">
          ...
          <p class="alaska text-3xl mb-8 leading-8">
            More about my <a href="/music" class="text-red-500" target="_blank">music</a> background.
          </p>
          <p class="alaska text-3xl leading-8">
            More about my <a href="/design" class="text-red-500" target="_blank">design</a> background.
          </p>
